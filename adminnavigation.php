<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
        ...
        <div class="sidebar-brand-text mx-3">Sekolah Methodist Karimun </div>
      </a>
    ...
    <li class="nav-item">
        <a class="nav-link" href="<?php echo base_url().'admin/gurutk'?>">
          <i class="fas fa-fw fa-address-book"></i>
          <span>Data Guru TK</span></a>
      </li>
	  
	  <li class="nav-item">
        <a class="nav-link" href="<?php echo base_url().'admin/guru'?>">
          <i class="fas fa-fw fa-address-book"></i>
          <span>Data Guru SD</span></a>
      </li>
    ...
    <li class="nav-item">
        <a class="nav-link" href="<?php echo base_url().'admin/files'?>">
          ...
          <span>Data Download File Sekolah</span></a>
      </li>
	  
	  <li class="nav-item">
        <a class="nav-link" href="<?php echo base_url().'admin/files1'?>">
          <i class="fas fa-fw fa-download"></i>
          <span>Data Download File Tugas</span></a>
      </li>
    ...
    <li class="nav-item">
	  ...
	  <li class="nav-item">
        <a class="nav-link" href="<?php echo base_url().'admin/Prestasitk'?>">
          <i class="fas fa-fw fa-volume-up"></i>
          <span>Data Prestasi TK</span></a>
      </li>
	  
	  <li class="nav-item">
        <a class="nav-link" href="<?php echo base_url().'admin/Prestasi'?>">
          <i class="fas fa-fw fa-volume-up"></i>
          <span>Data Prestasi SD </span></a>
      </li>
	  
	   <li class="nav-item">
        <a class="nav-link" href="<?php echo base_url().'admin/Fasilitastk'?>">
          <i class="fas fa-fw fa-volume-up"></i>
          <span>Data Fasilitas TK</span></a>
      </li>
	   ...
	   <li class="nav-item">
        <a class="nav-link" href="<?php echo base_url().'admin/Fasilitas'?>">
          <i class="fas fa-fw fa-volume-up"></i>
          <span>Data Fasilitas SD</span></a>
      </li>
	  
	  <li class="nav-item">
        <a class="nav-link" href="<?php echo base_url().'admin/aktivitas'?>">
          <i class="fas fa-fw fa-users"></i>
          <span>Data Aktivitas TK</span></a>
	  
	  <li class="nav-item">
        <a class="nav-link" href="<?php echo base_url().'admin/ekskul'?>">
          <i class="fas fa-fw fa-users"></i>
          <span>Data Ekstrakulikuler</span></a>
      </li>
	  <li class="nav-item">
        <a class="nav-link" href="<?php echo base_url().'admin/pembiasaan'?>">
          <i class="fas fa-fw fa-users"></i>
          <span>Kegiataan Pembiasaan</span></a>
      </li>
